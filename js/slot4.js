 function saveSettingsSlot4() {
	...
	localStorage.setItem("Slot4_Sexuality", sexuality);
	...
	localStorage.setItem("Slot4_Sexuality_Slider_Enabled", sexualitySliderEnabled);		
 ...
 function loadSettingsSlot4() {
	...
	if (lock.style.display === "block") {
		...
		var sexuality = localStorage.getItem("Slot4_Sexuality");
		...
		var sexualitySliderEnabled = localStorage.getItem("Slot4_Sexuality_Slider_Enabled");
