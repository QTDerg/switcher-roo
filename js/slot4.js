function saveSettingsSlot4() {
	...
	localStorage.setItem("Slot4_Custom_Slider4_Value", custom4);
	localStorage.setItem("Slot4_Custom_Slider5_Value", custom5);
	...
	localStorage.setItem("Slot4_Custom_Slider4_LeftText", leftText);	
	localStorage.setItem("Slot4_Custom_Slider4_CenterText", centerText);	
	localStorage.setItem("Slot4_Custom_Slider4_RightText", rightText);
	...
	localStorage.setItem("Slot4_Custom_Slider5_LeftText", leftText);	
	localStorage.setItem("Slot4_Custom_Slider5_CenterText", centerText);	
	localStorage.setItem("Slot4_Custom_Slider5_RightText", rightText);
	...
	localStorage.setItem("Slot4_Custom_Slider1_Enabled", isCS1Enabled);	
	localStorage.setItem("Slot4_Custom_Slider2_Enabled", isCS2Enabled);	
	localStorage.setItem("Slot4_Custom_Slider3_Enabled", isCS3Enabled);	
	localStorage.setItem("Slot4_Custom_Slider4_Enabled", isCS4Enabled);
	localStorage.setItem("Slot4_Custom_Slider5_Enabled", isCS5Enabled);
	...
	localStorage.setItem("Slot4_Custom_Checkbox1_Label", label);
	localStorage.setItem("Slot4_Custom_Checkbox1_Value1", value1);
	localStorage.setItem("Slot4_Custom_Checkbox1_Value2", value2);
	localStorage.setItem("Slot4_Custom_Checkbox1_Value1_Ticked", ticked1);
	localStorage.setItem("Slot4_Custom_Checkbox1_Value2_Ticked", ticked2);
	...
	localStorage.setItem("Slot4_Custom_Checkbox2_Label", label);
	localStorage.setItem("Slot4_Custom_Checkbox2_Value1", value1);
	localStorage.setItem("Slot4_Custom_Checkbox2_Value2", value2);
	localStorage.setItem("Slot4_Custom_Checkbox2_Value1_Ticked", ticked1);
	localStorage.setItem("Slot4_Custom_Checkbox2_Value2_Ticked", ticked2);	
	...
	localStorage.setItem("Slot4_Custom_Checkbox3_Label", label);
	localStorage.setItem("Slot4_Custom_Checkbox3_Value1", value1);
	localStorage.setItem("Slot4_Custom_Checkbox3_Value2", value2);
	localStorage.setItem("Slot4_Custom_Checkbox3_Value1_Ticked", ticked1);
	localStorage.setItem("Slot4_Custom_Checkbox3_Value2_Ticked", ticked2);
	...
	localStorage.setItem("Slot4_Custom_Checkbox1_Enabled", CC1Enabled);
	localStorage.setItem("Slot4_Custom_Checkbox2_Enabled", CC2Enabled);
	localStorage.setItem("Slot4_Custom_Checkbox3_Enabled", CC3Enabled);

	// Checkboxes end
		
	localStorage.setItem("Slot4_Species", settingSpecies);	
	localStorage.setItem("Slot4_Inanimate_Object", inanimateObject);
	...
	localStorage.setItem("Slot4_Hair_Lenght", hairLenght);
	localStorage.setItem("Slot4_Pregnancy_Lock_Box_Ticked", tickbox2);
	localStorage.setItem("Slot4_Fertility", fertility);
	localStorage.setItem("Slot4_Genitals_Menu_Penis_Box_Ticked", tickbox3);
	localStorage.setItem("Slot4_Genitals_Menu_Vagina_Box_Ticked", tickbox4);
	
	localStorage.setItem("Slot4_Butt_Size_Slider_Enabled", buttSizeSliderEnabled);	
	localStorage.setItem("Slot4_Belly_Size_Slider_Enabled", bellySizeSliderEnabled);		
	localStorage.setItem("Slot4_Belly_Shape_Slider_Enabled", bellyShapeSliderEnabled);		
	localStorage.setItem("Slot4_Hips_Slider_Enabled", hipsSliderEnabled);			
	localStorage.setItem("Slot4_Genital_Size_Slider_Enabled", genitalSizeSliderEnabled);	
	localStorage.setItem("Slot4_Cock_Type_Menu_Enabled", cockTypeMenuEnabled);			
	localStorage.setItem("Slot4_Libido_Slider_Enabled", libidoSliderEnabled);			
	localStorage.setItem("Slot4_Sensitivity_Slider_Enabled", sensitivitySliderEnabled);		
	localStorage.setItem("Slot4_Demeanor_Slider_Enabled", demeanorSliderEnabled);		
	localStorage.setItem("Slot4_Postion_Pref_Slider_Enabled", positionPrefSliderEnabled);	
	localStorage.setItem("Slot4_Intelligence_Slider_Enabled", intelligenceSliderEnabled);	
	localStorage.setItem("Slot4_Fluffiness_Slider_Enabled", fluffinessSliderEnabled);		
	localStorage.setItem("Slot4_Hair_Lenght_Slider_Enabled", hairLenghtSliderEnabled);	
	localStorage.setItem("Slot4_Fertility_Slider_Enabled", fertilitySliderEnabled);		
	localStorage.setItem("Slot4_Genitals_Menu_Enabled", genitalsMenuEnabled);			
	localStorage.setItem("Slot4_Species_Menu_Enabled", speciesMenuEnabled);			
	localStorage.setItem("Slot4_Sex_Menu_Enabled", sexMenuEnabled);				
	localStorage.setItem("Slot4_AC_Menu_Enabled", acMenuEnabled);				
	localStorage.setItem("Slot4_MascFem_Slider_Enabled", mascFemSliderEnabled);			
	localStorage.setItem("Slot4_ThinThicc_Slider_Enabled", thinThiccSliderEnabled);		
	localStorage.setItem("Slot4_SmolTall_Slider_Enabled", smolTallSliderEnabled);		
	localStorage.setItem("Slot4_Inanimate_Objects_Enabled", inanimateObjectsMenuEnabled);		
	...
	var charVizEnabled = localStorage.getItem("CharViz_Enabled");
		if (charVizEnabled === "Yes") {
			...
			localStorage.setItem("Slot4_CharViz_Body", body);
			localStorage.setItem("Slot4_CharViz_Head", head);
			localStorage.setItem("Slot4_CharViz_Tail", tail);
			localStorage.setItem("Slot4_CharViz_Wings", wings);
			localStorage.setItem("Slot4_CharViz_Pupils", pupils);
			...
			localStorage.setItem("Slot4_CharViz_Secondary", secondary);
			localStorage.setItem("Slot4_CharViz_Tertiary", tertiary);
			localStorage.setItem("Slot4_CharViz_Markings", markings);
			...
			localStorage.setItem("Slot4_CharViz_Topwear", topwear);
			localStorage.setItem("Slot4_CharViz_Bottomwear", bottomwear);
			localStorage.setItem("Slot4_CharViz_Armwear", armwear);
			localStorage.setItem("Slot4_CharViz_Legwear", legwear);
			localStorage.setItem("Slot4_CharViz_Underwear", underwear);
			localStorage.setItem("Slot4_CharViz_Accessories", accessories);
			...
			localStorage.setItem("Slot4_Primary_Character_Color", primaryCharColor);
			localStorage.setItem("Slot4_Secondary_Character_Color", secondaryCharColor);
			localStorage.setItem("Slot4_Tertiary_Character_Color", tertiaryCharColor);
			localStorage.setItem("Slot4_Markings_Character_Color", markingsCharColor);
			localStorage.setItem("Slot4_LeftEye_Character_Color", leftEyeCharColor);
			localStorage.setItem("Slot4_RightEye_Character_Color", rightEyeCharColor);
			localStorage.setItem("Slot4_Hair_Character_Color", hairCharColor);
			localStorage.setItem("Slot4_LeftSclera_Character_Color", leftScleraCharColor);
			localStorage.setItem("Slot4_RightSclera_Character_Color", rightScleraCharColor);
			...
			localStorage.setItem("Slot4_Topwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot4_Topwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot4_Bottomwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot4_Bottomwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot4_Armwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot4_Armwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot4_Legwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot4_Legwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot4_Underwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot4_Underwear_Secondary_Clothing_Color", secondaryTopwearColor);
			
		}
	
	var presetNameLocked = localStorage.getItem("Slot4_Preset_Name_Locked");	
	if (presetNameLocked != "Yes") {
		localStorage.setItem("Slot4_Preset_Name", settingSex + " " + settingSpecies);
	}	
	var presetName = localStorage.getItem("Slot4_Preset_Name");
...
function loadSettingsSlot4() {
	...
	if (lock.style.display === "block") {
		...
		var object = localStorage.getItem("Slot4_Inanimate_Object");
		if (object != null) {
		...
		var Fertility_Box_Ticked = localStorage.getItem("Slot4_Pregnancy_Lock_Box_Ticked");
		var tickbox2 = document.getElementById("pregnancyLockCheckbox");
		...
		var Genitals_Penis_Box_Ticked = localStorage.getItem("Slot4_Genitals_Menu_Penis_Box_Ticked");
		var tickbox3 = document.getElementById("genitalsPenisCheckbox");
		...
		var Genitals_Vagina_Box_Ticked = localStorage.getItem("Slot4_Genitals_Menu_Vagina_Box_Ticked");
		var tickbox4 = document.getElementById("genitalsVaginaCheckbox");
		...
		var hairLenght = localStorage.getItem("Slot4_Hair_Lenght");
		mySlider20.setValue(hairLenght);
						
		var fertility = localStorage.getItem("Slot4_Fertility");
		...
		var leftText = localStorage.getItem("Slot4_Custom_Slider4_LeftText");
		var centerText = localStorage.getItem("Slot4_Custom_Slider4_CenterText");
		var rightText = localStorage.getItem("Slot4_Custom_Slider4_RightText");
		...
		var leftText = localStorage.getItem("Slot4_Custom_Slider5_LeftText");
		var centerText = localStorage.getItem("Slot4_Custom_Slider5_CenterText");
		var rightText = localStorage.getItem("Slot4_Custom_Slider5_RightText");
		...
		var isCS1Enabled = localStorage.getItem("Slot4_Custom_Slider1_Enabled");
		var isCS2Enabled = localStorage.getItem("Slot4_Custom_Slider2_Enabled");
		var isCS3Enabled = localStorage.getItem("Slot4_Custom_Slider3_Enabled");
		var isCS4Enabled = localStorage.getItem("Slot4_Custom_Slider4_Enabled");
		var isCS5Enabled = localStorage.getItem("Slot4_Custom_Slider5_Enabled");
		...
		var CS4Value = localStorage.getItem("Slot4_Custom_Slider4_Value");
		var CS5Value = localStorage.getItem("Slot4_Custom_Slider5_Value");
		...
		var buttSizeSliderEnabled = localStorage.getItem("Slot4_Butt_Size_Slider_Enabled");
		var bellySizeSliderEnabled = localStorage.getItem("Slot4_Belly_Size_Slider_Enabled");
		var bellyShapeSliderEnabled = localStorage.getItem("Slot4_Belly_Shape_Slider_Enabled");
		var hipsSliderEnabled = localStorage.getItem("Slot4_Hips_Slider_Enabled");
		var genitalSizeSliderEnabled = localStorage.getItem("Slot4_Genital_Size_Slider_Enabled");
		var cockTypeMenuEnabled = localStorage.getItem("Slot4_Cock_Type_Menu_Enabled");
		var libidoSliderEnabled = localStorage.getItem("Slot4_Libido_Slider_Enabled");
		var sensitivitySliderEnabled = localStorage.getItem("Slot4_Sensitivity_Slider_Enabled");
		var demeanorSliderEnabled = localStorage.getItem("Slot4_Demeanor_Slider_Enabled");
		var positionPrefSliderEnabled = localStorage.getItem("Slot4_Postion_Pref_Slider_Enabled");
		var intelligenceSliderEnabled = localStorage.getItem("Slot4_Intelligence_Slider_Enabled");
		var fluffinessSliderEnabled = localStorage.getItem("Slot4_Fluffiness_Slider_Enabled");
		var hairLenghtSliderEnabled = localStorage.getItem("Slot4_Hair_Lenght_Slider_Enabled");
		var fertilitySliderEnabled = localStorage.getItem("Slot4_Fertility_Slider_Enabled");
		var genitalsMenuEnabled = localStorage.getItem("Slot4_Genitals_Menu_Enabled");
		var speciesMenuEnabled = localStorage.getItem("Slot4_Species_Menu_Enabled");
		var sexMenuEnabled = localStorage.getItem("Slot4_Sex_Menu_Enabled");
		var acMenuEnabled = localStorage.getItem("Slot4_AC_Menu_Enabled");
		var mascFemSliderEnabled = localStorage.getItem("Slot4_MascFem_Slider_Enabled");
		var thinThiccSliderEnabled = localStorage.getItem("Slot4_ThinThicc_Slider_Enabled");
		var smolTallSliderEnabled = localStorage.getItem("Slot4_SmolTall_Slider_Enabled");
		var inanimateObjectsMenuEnabled = localStorage.getItem("Slot4_Inanimate_Objects_Enabled");
		...
		var label = localStorage.getItem("Slot4_Custom_Checkbox1_Label");
		var value1 = localStorage.getItem("Slot4_Custom_Checkbox1_Value1");
		var value2 = localStorage.getItem("Slot4_Custom_Checkbox1_Value2");
		var ticked1 = localStorage.getItem("Slot4_Custom_Checkbox1_Value1_Ticked");
		var ticked2 = localStorage.getItem("Slot4_Custom_Checkbox1_Value2_Ticked");
		...
		var label = localStorage.getItem("Slot4_Custom_Checkbox2_Label");
		var value1 = localStorage.getItem("Slot4_Custom_Checkbox2_Value1");
		var value2 = localStorage.getItem("Slot4_Custom_Checkbox2_Value2");
		var ticked1 = localStorage.getItem("Slot4_Custom_Checkbox2_Value1_Ticked");
		var ticked2 = localStorage.getItem("Slot4_Custom_Checkbox2_Value2_Ticked");
		...
		var label = localStorage.getItem("Slot4_Custom_Checkbox3_Label");
		var value1 = localStorage.getItem("Slot4_Custom_Checkbox3_Value1");
		var value2 = localStorage.getItem("Slot4_Custom_Checkbox3_Value2");
		var ticked1 = localStorage.getItem("Slot4_Custom_Checkbox3_Value1_Ticked");
		var ticked2 = localStorage.getItem("Slot4_Custom_Checkbox3_Value2_Ticked");
		...
		var CC1Enabled = localStorage.getItem("Slot4_Custom_Checkbox1_Enabled");
		var CC2Enabled = localStorage.getItem("Slot4_Custom_Checkbox2_Enabled");
		var CC3Enabled = localStorage.getItem("Slot4_Custom_Checkbox3_Enabled");
		...
		if (charVizEnabled === "Yes") {
			...
			// Character parts
			var body = localStorage.getItem("Slot4_CharViz_Body");
			var head = localStorage.getItem("Slot4_CharViz_Head");
			var tail = localStorage.getItem("Slot4_CharViz_Tail");
			var wings = localStorage.getItem("Slot4_CharViz_Wings");
			var pupils = localStorage.getItem("Slot4_CharViz_Pupils");
			...
			// Character patterns
			var secondary = localStorage.getItem("Slot4_CharViz_Secondary");
			var tertiary = localStorage.getItem("Slot4_CharViz_Tertiary");
			var markings = localStorage.getItem("Slot4_CharViz_Markings");
			...
			// Clothes			
			var topwear = localStorage.getItem("Slot4_CharViz_Topwear");
			var bottomwear = localStorage.getItem("Slot4_CharViz_Bottomwear");
			var armwear = localStorage.getItem("Slot4_CharViz_Armwear");
			var legwear = localStorage.getItem("Slot4_CharViz_Legwear");	
			var underwear = localStorage.getItem("Slot4_CharViz_Underwear");
			var accessories = localStorage.getItem("Slot4_CharViz_Accessories");
			...
			// Character colors			
			var primaryCharColor = localStorage.getItem("Slot4_Primary_Character_Color");
			var secondaryCharColor = localStorage.getItem("Slot4_Secondary_Character_Color");
			var tertiaryCharColor = localStorage.getItem("Slot4_Tertiary_Character_Color");
			var markingsCharColor = localStorage.getItem("Slot4_Markings_Character_Color");
			var leftEyeCharColor = localStorage.getItem("Slot4_LeftEye_Character_Color");
			var rightEyeCharColor = localStorage.getItem("Slot4_RightEye_Character_Color");
			var hairCharColor = localStorage.getItem("Slot4_Hair_Character_Color");
			var leftScleraCharColor = localStorage.getItem("Slot4_LeftSclera_Character_Color");
			var rightScleraCharColor = localStorage.getItem("Slot4_RightSclera_Character_Color");
			...
			// Outfit colors			
			var primaryTopwearColor = localStorage.getItem("Slot4_Topwear_Primary_Clothing_Color");
			var secondaryTopwearColor = localStorage.getItem("Slot4_Topwear_Secondary_Clothing_Color");
			var primaryBottomwearColor = localStorage.getItem("Slot4_Bottomwear_Primary_Clothing_Color");
			var secondaryBottomwearColor = localStorage.getItem("Slot4_Bottomwear_Secondary_Clothing_Color");
			var primaryArmearColor = localStorage.getItem("Slot4_Armwear_Primary_Clothing_Color");
			var secondaryArmwearColor = localStorage.getItem("Slot4_Armwear_Secondary_Clothing_Color");
			var primaryLegwearColor = localStorage.getItem("Slot4_Legwear_Primary_Clothing_Color");
			var secondaryLegwearColor = localStorage.getItem("Slot4_Legwear_Secondary_Clothing_Color");
			var primaryUnderwearColor = localStorage.getItem("Slot4_Underwear_Primary_Clothing_Color");
			var secondaryUnderwearColor = localStorage.getItem("Slot4_Underwear_Secondary_Clothing_Color");
