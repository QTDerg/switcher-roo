function saveSettingsSlot5() {
	...
	var charVizEnabled = localStorage.getItem("CharViz_Enabled");
		if (charVizEnabled === "Yes") {
			...
			localStorage.setItem("Slot5_CharViz_Body", body);
			localStorage.setItem("Slot5_CharViz_Head", head);
			localStorage.setItem("Slot5_CharViz_Tail", tail);
			localStorage.setItem("Slot5_CharViz_Wings", wings);
			localStorage.setItem("Slot5_CharViz_Pupils", pupils);
			...
			localStorage.setItem("Slot5_CharViz_Secondary", secondary);
			localStorage.setItem("Slot5_CharViz_Tertiary", tertiary);
			localStorage.setItem("Slot5_CharViz_Markings", markings);
			...
			localStorage.setItem("Slot5_LeftSclera_Character_Color", leftScleraCharColor);
			localStorage.setItem("Slot5_RightSclera_Character_Color", rightScleraCharColor);
...
function loadSettingsSlot5() {
	...
	if (lock.style.display === "block") {
		...
		if (charVizEnabled === "Yes") {
			...
			// Character parts
			var body = localStorage.getItem("Slot5_CharViz_Body");
			var head = localStorage.getItem("Slot5_CharViz_Head");
			var tail = localStorage.getItem("Slot5_CharViz_Tail");
			var wings = localStorage.getItem("Slot5_CharViz_Wings");
			var pupils = localStorage.getItem("Slot5_CharViz_Pupils");
			...
			// Character patterns
			var secondary = localStorage.getItem("Slot5_CharViz_Secondary");
			var tertiary = localStorage.getItem("Slot5_CharViz_Tertiary");
			var markings = localStorage.getItem("Slot5_CharViz_Markings");
			...
			var leftScleraCharColor = localStorage.getItem("Slot5_LeftSclera_Character_Color");
			var rightScleraCharColor = localStorage.getItem("Slot5_RightSclera_Character_Color");
