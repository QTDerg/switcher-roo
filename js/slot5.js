 function saveSettingsSlot5() {
	...
	localStorage.setItem("Slot5_Sexuality_Slider_Enabled", sexualitySliderEnabled);		
 ...
 function loadSettingsSlot5() {
	...
	if (lock.style.display === "block") {
		...
		var sexuality = localStorage.getItem("Slot5_Sexuality");
		...
		var sexualitySliderEnabled = localStorage.getItem("Slot5_Sexuality_Slider_Enabled");
