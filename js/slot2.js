function saveSettingsSlot2() {
	...
	var charVizEnabled = localStorage.getItem("CharViz_Enabled");
		if (charVizEnabled === "Yes") {
			...
			localStorage.setItem("Slot2_CharViz_Body", body);
			localStorage.setItem("Slot2_CharViz_Head", head);
			localStorage.setItem("Slot2_CharViz_Tail", tail);
			localStorage.setItem("Slot2_CharViz_Wings", wings);
			localStorage.setItem("Slot2_CharViz_Pupils", pupils);
			...
			localStorage.setItem("Slot2_CharViz_Secondary", secondary);
			localStorage.setItem("Slot2_CharViz_Tertiary", tertiary);
			localStorage.setItem("Slot2_CharViz_Markings", markings);
			...
			localStorage.setItem("Slot2_CharViz_Topwear", topwear);
			localStorage.setItem("Slot2_CharViz_Bottomwear", bottomwear);
			localStorage.setItem("Slot2_CharViz_Armwear", armwear);
			localStorage.setItem("Slot2_CharViz_Legwear", legwear);
			localStorage.setItem("Slot2_CharViz_Underwear", underwear);
			localStorage.setItem("Slot2_CharViz_Accessories", accessories);
			...
			localStorage.setItem("Slot2_Primary_Character_Color", primaryCharColor);
			localStorage.setItem("Slot2_Secondary_Character_Color", secondaryCharColor);
			localStorage.setItem("Slot2_Tertiary_Character_Color", tertiaryCharColor);
			localStorage.setItem("Slot2_Markings_Character_Color", markingsCharColor);
			localStorage.setItem("Slot2_LeftEye_Character_Color", leftEyeCharColor);
			localStorage.setItem("Slot2_RightEye_Character_Color", rightEyeCharColor);
			localStorage.setItem("Slot2_Hair_Character_Color", hairCharColor);
			localStorage.setItem("Slot2_LeftSclera_Character_Color", leftScleraCharColor);
			localStorage.setItem("Slot2_RightSclera_Character_Color", rightScleraCharColor);
			...
			localStorage.setItem("Slot2_Topwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot2_Topwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot2_Bottomwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot2_Bottomwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot2_Armwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot2_Armwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot2_Legwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot2_Legwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot2_Underwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot2_Underwear_Secondary_Clothing_Color", secondaryTopwearColor);
...
function loadSettingsSlot2() {
	...
	if (lock.style.display === "block") {
		...
		if (charVizEnabled === "Yes") {
			...
			// Character parts
			var body = localStorage.getItem("Slot2_CharViz_Body");
			var head = localStorage.getItem("Slot2_CharViz_Head");
			var tail = localStorage.getItem("Slot2_CharViz_Tail");
			var wings = localStorage.getItem("Slot2_CharViz_Wings");
			var pupils = localStorage.getItem("Slot2_CharViz_Pupils");
			...
			// Character patterns
			var secondary = localStorage.getItem("Slot2_CharViz_Secondary");
			var tertiary = localStorage.getItem("Slot2_CharViz_Tertiary");
			var markings = localStorage.getItem("Slot2_CharViz_Markings");
			...
			// Clothes			
			var topwear = localStorage.getItem("Slot2_CharViz_Topwear");
			var bottomwear = localStorage.getItem("Slot2_CharViz_Bottomwear");
			var armwear = localStorage.getItem("Slot2_CharViz_Armwear");
			var legwear = localStorage.getItem("Slot2_CharViz_Legwear");	
			var underwear = localStorage.getItem("Slot2_CharViz_Underwear");
			var accessories = localStorage.getItem("Slot2_CharViz_Accessories");
			...
			// Character colors			
			var primaryCharColor = localStorage.getItem("Slot2_Primary_Character_Color");
			var secondaryCharColor = localStorage.getItem("Slot2_Secondary_Character_Color");
			var tertiaryCharColor = localStorage.getItem("Slot2_Tertiary_Character_Color");
			var markingsCharColor = localStorage.getItem("Slot2_Markings_Character_Color");
			var leftEyeCharColor = localStorage.getItem("Slot2_LeftEye_Character_Color");
			var rightEyeCharColor = localStorage.getItem("Slot2_RightEye_Character_Color");
			var hairCharColor = localStorage.getItem("Slot2_Hair_Character_Color");
			var leftScleraCharColor = localStorage.getItem("Slot2_LeftSclera_Character_Color");
			var rightScleraCharColor = localStorage.getItem("Slot2_RightSclera_Character_Color");
			...
			// Outfit colors			
			var primaryTopwearColor = localStorage.getItem("Slot2_Topwear_Primary_Clothing_Color");
			var secondaryTopwearColor = localStorage.getItem("Slot2_Topwear_Secondary_Clothing_Color");
			var primaryBottomwearColor = localStorage.getItem("Slot2_Bottomwear_Primary_Clothing_Color");
			var secondaryBottomwearColor = localStorage.getItem("Slot2_Bottomwear_Secondary_Clothing_Color");
			var primaryArmearColor = localStorage.getItem("Slot2_Armwear_Primary_Clothing_Color");
			var secondaryArmwearColor = localStorage.getItem("Slot2_Armwear_Secondary_Clothing_Color");
			var primaryLegwearColor = localStorage.getItem("Slot2_Legwear_Primary_Clothing_Color");
			var secondaryLegwearColor = localStorage.getItem("Slot2_Legwear_Secondary_Clothing_Color");
			var primaryUnderwearColor = localStorage.getItem("Slot2_Underwear_Primary_Clothing_Color");
			var secondaryUnderwearColor = localStorage.getItem("Slot2_Underwear_Secondary_Clothing_Color");
