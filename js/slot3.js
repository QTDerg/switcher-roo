 function saveSettingsSlot3() {
	...
	localStorage.setItem("Slot3_Hair_Color", hairColor);
	localStorage.setItem("Slot3_Swatch_Color", swatchColor);
	localStorage.setItem("Slot3_Hair_Lenght", hairLenght);
	localStorage.setItem("Slot3_Feral_Anthro", feralAnthro);
	...
	localStorage.setItem("Slot3_Feral_Anthro_Slider_Enabled", feralAnthroSliderEnabled);	
	localStorage.setItem("Slot3_Hair_Color_Menu_Enabled", hairColorMenuEnabled);		
	...
	var charVizEnabled = localStorage.getItem("CharViz_Enabled");
		if (charVizEnabled === "Yes") {
			...
			localStorage.setItem("Slot3_Character_Blushing", isBlushing);
 ...
 function loadSettingsSlot3() {
	...
	if (lock.style.display === "block") {
		...
		var feralAnthro = localStorage.getItem("Slot3_Feral_Anthro");
		...
		var hairColor = localStorage.getItem("Slot3_Hair_Color");
		var swatchColor = localStorage.getItem("Slot3_Swatch_Color");
		...
		var feralAnthroSliderEnabled = localStorage.getItem("Slot3_Feral_Anthro_Slider_Enabled");
		var hairColorMenuEnabled = localStorage.getItem("Slot3_Hair_Color_Menu_Enabled");
		...
		if (charVizEnabled === "Yes") {
			...
			var isBlushing = localStorage.getItem("Slot3_Character_Blushing");
