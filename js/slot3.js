 function saveSettingsSlot3() {
	...
	localStorage.setItem("Slot3_Sexuality", sexuality);
	...
	localStorage.setItem("Slot3_Sexuality_Slider_Enabled", sexualitySliderEnabled);		
 ...
 function loadSettingsSlot3() {
	...
	if (lock.style.display === "block") {
		...
		var sexuality = localStorage.getItem("Slot3_Sexuality");
		...
		var sexualitySliderEnabled = localStorage.getItem("Slot3_Sexuality_Slider_Enabled");
