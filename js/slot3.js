function saveSettingsSlot3() {
	...
	localStorage.setItem("Slot3_Custom_Slider1_Value", custom1);
	localStorage.setItem("Slot3_Custom_Slider2_Value", custom2);
	localStorage.setItem("Slot3_Custom_Slider3_Value", custom3);
	localStorage.setItem("Slot3_Custom_Slider4_Value", custom4);
	localStorage.setItem("Slot3_Custom_Slider5_Value", custom5);
	...
	localStorage.setItem("Slot3_Custom_Slider1_LeftText", leftText);	
	localStorage.setItem("Slot3_Custom_Slider1_CenterText", centerText);	
	localStorage.setItem("Slot3_Custom_Slider1_RightText", rightText);	
	...
	localStorage.setItem("Slot3_Custom_Slider2_LeftText", leftText);	
	localStorage.setItem("Slot3_Custom_Slider2_CenterText", centerText);	
	localStorage.setItem("Slot3_Custom_Slider2_RightText", rightText);	
	...
	localStorage.setItem("Slot3_Custom_Slider4_LeftText", leftText);	
	localStorage.setItem("Slot3_Custom_Slider4_CenterText", centerText);	
	localStorage.setItem("Slot3_Custom_Slider4_RightText", rightText);
	...
	localStorage.setItem("Slot3_Custom_Slider5_LeftText", leftText);	
	localStorage.setItem("Slot3_Custom_Slider5_CenterText", centerText);	
	localStorage.setItem("Slot3_Custom_Slider5_RightText", rightText);
	...
	localStorage.setItem("Slot3_Custom_Slider4_Enabled", isCS4Enabled);
	localStorage.setItem("Slot3_Custom_Slider5_Enabled", isCS5Enabled);
	...
	localStorage.setItem("Slot3_Custom_Checkbox1_Label", label);
	localStorage.setItem("Slot3_Custom_Checkbox1_Value1", value1);
	localStorage.setItem("Slot3_Custom_Checkbox1_Value2", value2);
	localStorage.setItem("Slot3_Custom_Checkbox1_Value1_Ticked", ticked1);
	localStorage.setItem("Slot3_Custom_Checkbox1_Value2_Ticked", ticked2);
	...
	localStorage.setItem("Slot3_Custom_Checkbox2_Label", label);
	localStorage.setItem("Slot3_Custom_Checkbox2_Value1", value1);
	localStorage.setItem("Slot3_Custom_Checkbox2_Value2", value2);
	localStorage.setItem("Slot3_Custom_Checkbox2_Value1_Ticked", ticked1);
	localStorage.setItem("Slot3_Custom_Checkbox2_Value2_Ticked", ticked2);	
	...
	localStorage.setItem("Slot3_Custom_Checkbox3_Label", label);
	localStorage.setItem("Slot3_Custom_Checkbox3_Value1", value1);
	localStorage.setItem("Slot3_Custom_Checkbox3_Value2", value2);
	localStorage.setItem("Slot3_Custom_Checkbox3_Value1_Ticked", ticked1);
	localStorage.setItem("Slot3_Custom_Checkbox3_Value2_Ticked", ticked2);
	...
	localStorage.setItem("Slot3_Custom_Checkbox1_Enabled", CC1Enabled);
	localStorage.setItem("Slot3_Custom_Checkbox2_Enabled", CC2Enabled);
	localStorage.setItem("Slot3_Custom_Checkbox3_Enabled", CC3Enabled);

	// Checkboxes end
		
	localStorage.setItem("Slot3_Species", settingSpecies);	
	localStorage.setItem("Slot3_Inanimate_Object", inanimateObject);
    localStorage.setItem("Slot3_Sex", settingSex);	
	localStorage.setItem("Slot3_AC_Box_Ticked", tickbox);
	localStorage.setItem("Slot3_Body_Type1", bodyType1);
	localStorage.setItem("Slot3_Body_Type2", bodyType2);
	localStorage.setItem("Slot3_Body_Type3", bodyType3);
	localStorage.setItem("Slot3_Hips", hips);
	localStorage.setItem("Slot3_Genital_Size", genitalSize);
	localStorage.setItem("Slot3_Fluffiness", fluffiness);
	localStorage.setItem("Slot3_Libido", libido);
	localStorage.setItem("Slot3_Position_Preference", domsub);
	localStorage.setItem("Slot3_Sensitivity", sensitivity);
	localStorage.setItem("Slot3_Demeanor", assertiveShy); 
	localStorage.setItem("Slot3_Breast_Size_Male", breastSizeMale); 
	localStorage.setItem("Slot3_Breast_Size_Female", breastSizeFemale); 
	localStorage.setItem("Slot3_Butt_Size", buttSize);
	localStorage.setItem("Slot3_Belly_Size", bellySize);
	localStorage.setItem("Slot3_Belly_Shape", bellyShape);
	localStorage.setItem("Slot3_Intelligence", intelligence);
	localStorage.setItem("Slot3_Cock_Type", cockType);
	localStorage.setItem("Slot3_Hair_Lenght", hairLenght);
	localStorage.setItem("Slot3_Pregnancy_Lock_Box_Ticked", tickbox2);
	localStorage.setItem("Slot3_Fertility", fertility);
	localStorage.setItem("Slot3_Genitals_Menu_Penis_Box_Ticked", tickbox3);
	localStorage.setItem("Slot3_Genitals_Menu_Vagina_Box_Ticked", tickbox4);
	
	localStorage.setItem("Slot3_Butt_Size_Slider_Enabled", buttSizeSliderEnabled);	
	localStorage.setItem("Slot3_Belly_Size_Slider_Enabled", bellySizeSliderEnabled);		
	localStorage.setItem("Slot3_Belly_Shape_Slider_Enabled", bellyShapeSliderEnabled);		
	localStorage.setItem("Slot3_Hips_Slider_Enabled", hipsSliderEnabled);			
	localStorage.setItem("Slot3_Genital_Size_Slider_Enabled", genitalSizeSliderEnabled);	
	localStorage.setItem("Slot3_Cock_Type_Menu_Enabled", cockTypeMenuEnabled);			
	localStorage.setItem("Slot3_Libido_Slider_Enabled", libidoSliderEnabled);			
	localStorage.setItem("Slot3_Sensitivity_Slider_Enabled", sensitivitySliderEnabled);		
	localStorage.setItem("Slot3_Demeanor_Slider_Enabled", demeanorSliderEnabled);		
	localStorage.setItem("Slot3_Postion_Pref_Slider_Enabled", positionPrefSliderEnabled);	
	localStorage.setItem("Slot3_Intelligence_Slider_Enabled", intelligenceSliderEnabled);	
	localStorage.setItem("Slot3_Fluffiness_Slider_Enabled", fluffinessSliderEnabled);		
	localStorage.setItem("Slot3_Hair_Lenght_Slider_Enabled", hairLenghtSliderEnabled);	
	localStorage.setItem("Slot3_Fertility_Slider_Enabled", fertilitySliderEnabled);		
	localStorage.setItem("Slot3_Genitals_Menu_Enabled", genitalsMenuEnabled);			
	localStorage.setItem("Slot3_Species_Menu_Enabled", speciesMenuEnabled);			
	localStorage.setItem("Slot3_Sex_Menu_Enabled", sexMenuEnabled);				
	localStorage.setItem("Slot3_AC_Menu_Enabled", acMenuEnabled);				
	localStorage.setItem("Slot3_MascFem_Slider_Enabled", mascFemSliderEnabled);			
	localStorage.setItem("Slot3_ThinThicc_Slider_Enabled", thinThiccSliderEnabled);		
	localStorage.setItem("Slot3_SmolTall_Slider_Enabled", smolTallSliderEnabled);		
	localStorage.setItem("Slot3_Inanimate_Objects_Enabled", inanimateObjectsMenuEnabled);		
	...
	var charVizEnabled = localStorage.getItem("CharViz_Enabled");
		if (charVizEnabled === "Yes") {
			...
			localStorage.setItem("Slot3_CharViz_Body", body);
			localStorage.setItem("Slot3_CharViz_Head", head);
			localStorage.setItem("Slot3_CharViz_Tail", tail);
			localStorage.setItem("Slot3_CharViz_Wings", wings);
			localStorage.setItem("Slot3_CharViz_Pupils", pupils);
			...
			localStorage.setItem("Slot3_CharViz_Secondary", secondary);
			localStorage.setItem("Slot3_CharViz_Tertiary", tertiary);
			localStorage.setItem("Slot3_CharViz_Markings", markings);
			...
			localStorage.setItem("Slot3_CharViz_Topwear", topwear);
			localStorage.setItem("Slot3_CharViz_Bottomwear", bottomwear);
			localStorage.setItem("Slot3_CharViz_Armwear", armwear);
			localStorage.setItem("Slot3_CharViz_Legwear", legwear);
			localStorage.setItem("Slot3_CharViz_Underwear", underwear);
			localStorage.setItem("Slot3_CharViz_Accessories", accessories);
			...
			localStorage.setItem("Slot3_Primary_Character_Color", primaryCharColor);
			localStorage.setItem("Slot3_Secondary_Character_Color", secondaryCharColor);
			localStorage.setItem("Slot3_Tertiary_Character_Color", tertiaryCharColor);
			localStorage.setItem("Slot3_Markings_Character_Color", markingsCharColor);
			localStorage.setItem("Slot3_LeftEye_Character_Color", leftEyeCharColor);
			localStorage.setItem("Slot3_RightEye_Character_Color", rightEyeCharColor);
			localStorage.setItem("Slot3_Hair_Character_Color", hairCharColor);
			localStorage.setItem("Slot3_LeftSclera_Character_Color", leftScleraCharColor);
			localStorage.setItem("Slot3_RightSclera_Character_Color", rightScleraCharColor);
			...
			localStorage.setItem("Slot3_Topwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot3_Topwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot3_Bottomwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot3_Bottomwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot3_Armwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot3_Armwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot3_Legwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot3_Legwear_Secondary_Clothing_Color", secondaryTopwearColor);
			localStorage.setItem("Slot3_Underwear_Primary_Clothing_Color", primaryTopwearColor);
			localStorage.setItem("Slot3_Underwear_Secondary_Clothing_Color", secondaryTopwearColor);
			
		}
	
	var presetNameLocked = localStorage.getItem("Slot3_Preset_Name_Locked");	
	if (presetNameLocked != "Yes") {
		localStorage.setItem("Slot3_Preset_Name", settingSex + " " + settingSpecies);
	}	
	var presetName = localStorage.getItem("Slot3_Preset_Name");
...
function loadSettingsSlot3() {
	...
	if (lock.style.display === "block") {
		...
		var object = localStorage.getItem("Slot3_Inanimate_Object");
		if (object != null) {
		...
		var AC_Box_Ticked = localStorage.getItem("Slot3_AC_Box_Ticked");
		var tickbox = document.getElementById("adaptClothingCheckbox");
		...
		var Fertility_Box_Ticked = localStorage.getItem("Slot3_Pregnancy_Lock_Box_Ticked");
		var tickbox2 = document.getElementById("pregnancyLockCheckbox");
		...
		var Genitals_Penis_Box_Ticked = localStorage.getItem("Slot3_Genitals_Menu_Penis_Box_Ticked");
		var tickbox3 = document.getElementById("genitalsPenisCheckbox");
		...
		var Genitals_Vagina_Box_Ticked = localStorage.getItem("Slot3_Genitals_Menu_Vagina_Box_Ticked");
		var tickbox4 = document.getElementById("genitalsVaginaCheckbox");
		...
		var bodyType1 = localStorage.getItem("Slot3_Body_Type1");
		mySlider6.setValue(bodyType1);
 
		var bodyType2 = localStorage.getItem("Slot3_Body_Type2");
		mySlider5.setValue(bodyType2);
 
		var bodyType3 = localStorage.getItem("Slot3_Body_Type3");
		mySlider4.setValue(bodyType3);
		  
		var hips = localStorage.getItem("Slot3_Hips");
		mySlider3.setValue(hips);
 
		var genitalSize = localStorage.getItem("Slot3_Genital_Size");
		mySlider2.setValue(genitalSize);
 
		var fluffiness = localStorage.getItem("Slot3_Fluffiness");
		mySlider.setValue(fluffiness);
 
		var libido = localStorage.getItem("Slot3_Libido");
		mySlider7.setValue(libido);
 
		var domsub = localStorage.getItem("Slot3_Position_Preference");
		mySlider10.setValue(domsub);
 
		var sensitivity = localStorage.getItem("Slot3_Sensitivity");
		mySlider11.setValue(sensitivity);
 
		var assertiveShy = localStorage.getItem("Slot3_Demeanor");
		mySlider12.setValue(assertiveShy);
 
		var buttSize = localStorage.getItem("Slot3_Butt_Size");	
		mySlider13.setValue(buttSize);
 
		var bellySize = localStorage.getItem("Slot3_Belly_Size");
		mySlider14.setValue(bellySize);
 
		var bellyShape = localStorage.getItem("Slot3_Belly_Shape");
		mySlider15.setValue(bellyShape);
 
		var intelligence = localStorage.getItem("Slot3_Intelligence");
		mySlider16.setValue(intelligence);
		
		var hairLenght = localStorage.getItem("Slot3_Hair_Lenght");
		mySlider20.setValue(hairLenght);
						
		var fertility = localStorage.getItem("Slot3_Fertility");
		mySlider23.setValue(fertility);
		
		var cockType = localStorage.getItem("Slot3_Cock_Type");
		...
		var leftText = localStorage.getItem("Slot3_Custom_Slider1_LeftText");
		var centerText = localStorage.getItem("Slot3_Custom_Slider1_CenterText");
		var rightText = localStorage.getItem("Slot3_Custom_Slider1_RightText");
		...
		var leftText = localStorage.getItem("Slot3_Custom_Slider2_LeftText");
		var centerText = localStorage.getItem("Slot3_Custom_Slider2_CenterText");
		var rightText = localStorage.getItem("Slot3_Custom_Slider2_RightText");
		...
		var leftText = localStorage.getItem("Slot3_Custom_Slider3_LeftText");
		var centerText = localStorage.getItem("Slot3_Custom_Slider3_CenterText");
		var rightText = localStorage.getItem("Slot3_Custom_Slider3_RightText");
		...
		var leftText = localStorage.getItem("Slot3_Custom_Slider4_LeftText");
		var centerText = localStorage.getItem("Slot3_Custom_Slider4_CenterText");
		var rightText = localStorage.getItem("Slot3_Custom_Slider4_RightText");
		...
		var leftText = localStorage.getItem("Slot3_Custom_Slider5_LeftText");
		var centerText = localStorage.getItem("Slot3_Custom_Slider5_CenterText");
		var rightText = localStorage.getItem("Slot3_Custom_Slider5_RightText");
		...
		var isCS4Enabled = localStorage.getItem("Slot3_Custom_Slider4_Enabled");
		var isCS5Enabled = localStorage.getItem("Slot3_Custom_Slider5_Enabled");
		
		var CS1Value = localStorage.getItem("Slot3_Custom_Slider1_Value");
		var CS2Value = localStorage.getItem("Slot3_Custom_Slider2_Value");
		var CS3Value = localStorage.getItem("Slot3_Custom_Slider3_Value");
		var CS4Value = localStorage.getItem("Slot3_Custom_Slider4_Value");
		var CS5Value = localStorage.getItem("Slot3_Custom_Slider5_Value");
		...
		var buttSizeSliderEnabled = localStorage.getItem("Slot3_Butt_Size_Slider_Enabled");
		var bellySizeSliderEnabled = localStorage.getItem("Slot3_Belly_Size_Slider_Enabled");
		var bellyShapeSliderEnabled = localStorage.getItem("Slot3_Belly_Shape_Slider_Enabled");
		var hipsSliderEnabled = localStorage.getItem("Slot3_Hips_Slider_Enabled");
		var genitalSizeSliderEnabled = localStorage.getItem("Slot3_Genital_Size_Slider_Enabled");
		var cockTypeMenuEnabled = localStorage.getItem("Slot3_Cock_Type_Menu_Enabled");
		var libidoSliderEnabled = localStorage.getItem("Slot3_Libido_Slider_Enabled");
		var sensitivitySliderEnabled = localStorage.getItem("Slot3_Sensitivity_Slider_Enabled");
		var demeanorSliderEnabled = localStorage.getItem("Slot3_Demeanor_Slider_Enabled");
		var positionPrefSliderEnabled = localStorage.getItem("Slot3_Postion_Pref_Slider_Enabled");
		var intelligenceSliderEnabled = localStorage.getItem("Slot3_Intelligence_Slider_Enabled");
		var fluffinessSliderEnabled = localStorage.getItem("Slot3_Fluffiness_Slider_Enabled");
		var hairLenghtSliderEnabled = localStorage.getItem("Slot3_Hair_Lenght_Slider_Enabled");
		var fertilitySliderEnabled = localStorage.getItem("Slot3_Fertility_Slider_Enabled");
		var genitalsMenuEnabled = localStorage.getItem("Slot3_Genitals_Menu_Enabled");
		var speciesMenuEnabled = localStorage.getItem("Slot3_Species_Menu_Enabled");
		var sexMenuEnabled = localStorage.getItem("Slot3_Sex_Menu_Enabled");
		var acMenuEnabled = localStorage.getItem("Slot3_AC_Menu_Enabled");
		var mascFemSliderEnabled = localStorage.getItem("Slot3_MascFem_Slider_Enabled");
		var thinThiccSliderEnabled = localStorage.getItem("Slot3_ThinThicc_Slider_Enabled");
		var smolTallSliderEnabled = localStorage.getItem("Slot3_SmolTall_Slider_Enabled");
		var inanimateObjectsMenuEnabled = localStorage.getItem("Slot3_Inanimate_Objects_Enabled");
		...
		var label = localStorage.getItem("Slot3_Custom_Checkbox1_Label");
		var value1 = localStorage.getItem("Slot3_Custom_Checkbox1_Value1");
		var value2 = localStorage.getItem("Slot3_Custom_Checkbox1_Value2");
		var ticked1 = localStorage.getItem("Slot3_Custom_Checkbox1_Value1_Ticked");
		var ticked2 = localStorage.getItem("Slot3_Custom_Checkbox1_Value2_Ticked");
		...
		var label = localStorage.getItem("Slot3_Custom_Checkbox2_Label");
		var value1 = localStorage.getItem("Slot3_Custom_Checkbox2_Value1");
		var value2 = localStorage.getItem("Slot3_Custom_Checkbox2_Value2");
		var ticked1 = localStorage.getItem("Slot3_Custom_Checkbox2_Value1_Ticked");
		var ticked2 = localStorage.getItem("Slot3_Custom_Checkbox2_Value2_Ticked");
		...
		var label = localStorage.getItem("Slot3_Custom_Checkbox3_Label");
		var value1 = localStorage.getItem("Slot3_Custom_Checkbox3_Value1");
		var value2 = localStorage.getItem("Slot3_Custom_Checkbox3_Value2");
		var ticked1 = localStorage.getItem("Slot3_Custom_Checkbox3_Value1_Ticked");
		var ticked2 = localStorage.getItem("Slot3_Custom_Checkbox3_Value2_Ticked");
		...
		var CC1Enabled = localStorage.getItem("Slot3_Custom_Checkbox1_Enabled");
		var CC2Enabled = localStorage.getItem("Slot3_Custom_Checkbox2_Enabled");
		var CC3Enabled = localStorage.getItem("Slot3_Custom_Checkbox3_Enabled");
		...
		if (charVizEnabled === "Yes") {
			...
			// Character parts
			var body = localStorage.getItem("Slot3_CharViz_Body");
			var head = localStorage.getItem("Slot3_CharViz_Head");
			var tail = localStorage.getItem("Slot3_CharViz_Tail");
			var wings = localStorage.getItem("Slot3_CharViz_Wings");
			var pupils = localStorage.getItem("Slot3_CharViz_Pupils");
			...
			// Character patterns
			var secondary = localStorage.getItem("Slot3_CharViz_Secondary");
			var tertiary = localStorage.getItem("Slot3_CharViz_Tertiary");
			var markings = localStorage.getItem("Slot3_CharViz_Markings");
			...
			// Clothes			
			var topwear = localStorage.getItem("Slot3_CharViz_Topwear");
			var bottomwear = localStorage.getItem("Slot3_CharViz_Bottomwear");
			var armwear = localStorage.getItem("Slot3_CharViz_Armwear");
			var legwear = localStorage.getItem("Slot3_CharViz_Legwear");	
			var underwear = localStorage.getItem("Slot3_CharViz_Underwear");
			var accessories = localStorage.getItem("Slot3_CharViz_Accessories");
			...
			// Character colors			
			var primaryCharColor = localStorage.getItem("Slot3_Primary_Character_Color");
			var secondaryCharColor = localStorage.getItem("Slot3_Secondary_Character_Color");
			var tertiaryCharColor = localStorage.getItem("Slot3_Tertiary_Character_Color");
			var markingsCharColor = localStorage.getItem("Slot3_Markings_Character_Color");
			var leftEyeCharColor = localStorage.getItem("Slot3_LeftEye_Character_Color");
			var rightEyeCharColor = localStorage.getItem("Slot3_RightEye_Character_Color");
			var hairCharColor = localStorage.getItem("Slot3_Hair_Character_Color");
			var leftScleraCharColor = localStorage.getItem("Slot3_LeftSclera_Character_Color");
			var rightScleraCharColor = localStorage.getItem("Slot3_RightSclera_Character_Color");
			...
			// Outfit colors			
			var primaryTopwearColor = localStorage.getItem("Slot3_Topwear_Primary_Clothing_Color");
			var secondaryTopwearColor = localStorage.getItem("Slot3_Topwear_Secondary_Clothing_Color");
			var primaryBottomwearColor = localStorage.getItem("Slot3_Bottomwear_Primary_Clothing_Color");
			var secondaryBottomwearColor = localStorage.getItem("Slot3_Bottomwear_Secondary_Clothing_Color");
			var primaryArmearColor = localStorage.getItem("Slot3_Armwear_Primary_Clothing_Color");
			var secondaryArmwearColor = localStorage.getItem("Slot3_Armwear_Secondary_Clothing_Color");
			var primaryLegwearColor = localStorage.getItem("Slot3_Legwear_Primary_Clothing_Color");
			var secondaryLegwearColor = localStorage.getItem("Slot3_Legwear_Secondary_Clothing_Color");
			var primaryUnderwearColor = localStorage.getItem("Slot3_Underwear_Primary_Clothing_Color");
			var secondaryUnderwearColor = localStorage.getItem("Slot3_Underwear_Secondary_Clothing_Color");
